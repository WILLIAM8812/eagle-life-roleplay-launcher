        ...
        switch(arg){
            ...
            case 'update-available':
                ...
                if(process.platform === 'darwin'){
                    info.darwindownload = `https://github.com/WILLIAM8812/eagle-life-roleplay-launcher/releases/download/v${info.version}/Eagle.Life.Rp.-.Launcher-setup-${info.version}${process.arch === 'arm64' ? '-arm64' : ''}.dmg`
                    showUpdateUI(info)
                }
